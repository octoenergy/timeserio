...
project = 'Timeserio'
copyright = '2019, Octopus Energy Ltd'
author = 'Octopus Energy Ltd'
...
html_logo = '_static/constantine_100px.png'
...
htmlhelp_basename = 'timeseriodocs'
...
latex_documents = [
    (master_doc, 'timeserio.tex', 'timeserio Documentation',
     'Octopus Energy Ltd', 'manual'),
]
...
man_pages = [
    (master_doc, 'timeserio', 'timeserio Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'timeserio', 'timeserio Documentation',
     author, 'timeserio', 'One line description of project.',
     'Miscellaneous'),
]
...
.. only:: html
    ...
    __ https://github.com/octoenergy/timeserio/blob/
        """ +
git_rev + r"{{ docpath }}"
)
